...
class HelpMsgResponder(BaseMsgResponder):
    """Represents a message responder which creates responses for help messages."""

    async def can_respond(self, recognized_message: RecognizedMessage, channel: str, **kwargs) -> bool:
        # This responder can respond to a message with any intent, because it just sends a help message.
        return True
